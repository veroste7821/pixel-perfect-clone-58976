  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Esta página no existe o ha sido movida.</p>
        <div className="mt-6">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Agenda IA · Turnos por WhatsApp" },
      { name: "description", content: "Recibe turnos por WhatsApp sin llamadas ni mensajes interminables. Agenda inteligente para profesionales." },
      { property: "og:title", content: "Agenda IA · Turnos por WhatsApp" },
      { property: "og:description", content: "Recibe turnos por WhatsApp sin llamadas ni mensajes interminables." },
